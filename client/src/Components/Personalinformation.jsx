...
import { Mail, User,Phone, MapPin, BriefcaseBusiness, Globe} from 'lucide-react'
   ...
   const fields=[
    ...
    {key: "linkedin",label: "LinkedIn Profile", icon: BriefcaseBusiness ,type: "url", required: false },
