...
const TemplateSelector = ({selectedTemplate,onChange}) => {
  const [isOpen,setIsOpen]=useState(false)
    ...
    },
    {
        id:'modern',
        name:'Modern',
        preview: "A sleek, contemporary design with bold headings and a two-column layout"
    },
    {
        id:'minimal',
        name:'Minimal',
        preview: "A clean, minimalist design with ample white space and a focus on readability"
    },
    {
        id:'minimal-image',
        name:'Minimal Image',
        preview: "A clean, minimalist design with ample white space and a focus on readability, including an optional image section"    
    },
  ]
  return (
    <div className='relative'>
        <button onClick={()=>setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-blue text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg'>
